...
1. A payload DTO in `Infrastructure/Http/{Resource}/Dto/{Resource}WebhookPayloadDto.php` implementing `App\Catalog\Application\Command\HandleWebhook\Dto\WebhookPayloadDtoInterface` (single method `gid(): ShopifyGid`).
